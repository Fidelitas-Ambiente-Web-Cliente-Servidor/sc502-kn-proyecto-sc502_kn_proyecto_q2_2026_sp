      ...
      <div class="col-lg-3">
        <div class="bg-white rounded-4 shadow-sm p-4 mb-4 border border-light-subtle">
          ...
          <nav class="nav flex-column gap-2 mb-0">
            <a href="#"
              class="nav-link active rounded-3 p-3 d-flex justify-content-between align-items-center side-link">
              <span class="fw-semibold"><i class="fa-solid fa-paw me-3"></i>Mis Mascotas</span>
              <span class="badge rounded-pill">12</span>
            </a>
            <a href="#"
              class="nav-link text-dark rounded-3 p-3 d-flex justify-content-between align-items-center side-link">
              <span class="fw-semibold text-secondary"><i class="fa-regular fa-file-lines me-3"></i>Solicitudes</span>
              <span class="badge rounded-pill badge-orange">4</span>
            </a>
